...
def main():
    ...
    data_table_entry = dict(name=params['param_dict']['name'], 
                            taxid=params['param_dict']['taxid'],
                            value=params['param_dict']['idtag'],
                            refseqsciname=params['param_dict']['refseqsciname'],
                            refseqprefix=params['param_dict']['refseqprefix'])
 
    data_manager_dict = add_data_table_entry( {}, 'all_proteome_species', data_table_entry )
